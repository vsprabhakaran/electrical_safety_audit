...
$objPHPExcel->getActiveSheet()->setTitle('Pending Status');
$objPHPExcel->setActiveSheetIndex(0);
mysqli_close($con);

header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="Pending Branch Electrical and Safety Audit Compliance.xls"');
